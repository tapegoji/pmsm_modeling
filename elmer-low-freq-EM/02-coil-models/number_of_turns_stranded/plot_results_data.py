...
def main():
    ...
    metadata_filenames = ["results_stranded1/w1.dat.names", "results_stranded10/w1.dat.names"]  # Update as needed
    data_filenames = ["results_stranded1/w1.dat", "results_stranded10/w1.dat"]  # Update as needed
    file_labels = ["1 Turn", "10 Turns"]  # Labels for each dataset
