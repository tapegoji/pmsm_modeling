...
# ------------------ Circuit 1 (Current Source - Transient)---------------------
    ...
    # stranded coil positive terminal
    terminal_2p = ElmerComponent("T2p", 3, 1, 3, ["WIRE2p"])
    terminal_2p.stranded(1,rdc)

    # stranded coil negative terminal
    terminal_2m = ElmerComponent("T2m", 3, 2, 4, ["WIRE2m"])
    terminal_2m.stranded(1,rdc)

    # store components in array components = [comp1, comp2,...] - do not remove
    c[2].components.append([i2, terminal_2p, terminal_2m])
    ...
    # stranded coil positive terminal
    terminal_3p = ElmerComponent("T3p", 3, 1, 5, ["WIRE3p"])
    terminal_3p.stranded(1,rdc)

    # stranded coil negative terminal
    terminal_3m = ElmerComponent("T3m", 3, 2, 6, ["WIRE3m"])
    terminal_3m.stranded(1,rdc)

    # store components in array components = [comp1, comp2,...] - do not remove
    c[3].components.append([i3, terminal_3p, terminal_3m])
    # --------------------------------------------------
